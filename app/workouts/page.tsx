    ...
    <div className="relative mx-auto flex h-auto min-h-screen w-full max-w-md flex-col bg-background-light dark:bg-background-dark pb-28">
      ...
      <div className="px-4 pb-4">
        <div className="flex gap-2 overflow-x-auto pb-2 -mx-4 px-4">
          ...
          <div className="flex h-10 shrink-0 basis-1/7 grow flex-col items-center justify-center gap-y-1 rounded-full bg-gradient-to-br from-primary-start to-primary-end px-2 text-white shadow-lg">
      ...
      <div className="px-4 pb-4">
        <div className="flex items-stretch justify-between gap-4 rounded-xl bg-white dark:bg-gray-800/50 p-4 shadow-sm">
          <div className="flex flex-[2_2_0px] flex-col gap-4">
            ...
            <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-9 px-4 flex-row-reverse bg-gradient-to-br from-primary-start to-primary-end text-white text-sm font-medium leading-normal w-fit shadow-md">
      ...
      <div className="flex items-center gap-4 bg-background-light dark:bg-background-dark px-4 min-h-[72px] py-2 justify-between">
        <div className="flex items-center gap-4">
          <div className="text-gray-900 dark:text-white flex items-center justify-center rounded-lg bg-white dark:bg-gray-800/50 shrink-0 size-12">
            <span className="material-symbols-outlined text-transparent bg-clip-text bg-gradient-to-br from-primary-start to-primary-end">directions_run</span>
          </div>
      ...
      <div className="flex items-center gap-4 bg-background-light dark:bg-background-dark px-4 min-h-[72px] py-2 justify-between">
        <div className="flex items-center gap-4">
          <div className="text-gray-900 dark:text-white flex items-center justify-center rounded-lg bg-white dark:bg-gray-800/50 shrink-0 size-12">
            <span className="material-symbols-outlined text-transparent bg-clip-text bg-gradient-to-br from-primary-start to-primary-end">self_improvement</span>
          </div>
          <div className="flex flex-col justify-center">
      ...
      <div className="px-4 pt-6">
        <div className="flex flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-gray-300 dark:border-gray-700 bg-white/50 dark:bg-gray-800/30 p-8 text-center">
          <div className="flex items-center justify-center rounded-full size-16 bg-gradient-to-br from-primary-start/20 to-primary-end/20">
            <span className="material-symbols-outlined text-transparent bg-clip-text bg-gradient-to-br from-primary-start to-primary-end text-3xl">add</span>
          </div>
          <div className="flex flex-col gap-1">
          ...
          <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-9 px-4 mt-2 bg-gradient-to-br from-primary-start/20 to-primary-end/20 text-primary-start text-sm font-medium leading-normal">
