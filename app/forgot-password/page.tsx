    ...
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-x-hidden p-4">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <button className="flex items-center justify-center whitespace-nowrap h-14 w-full rounded-lg bg-gradient-primary text-white text-base font-bold leading-normal mt-4 transition-transform duration-200 ease-in-out hover:scale-[1.02] shadow-[0_4px_15px_0_rgba(244,92,67,0.3)] hover:shadow-[0_4px_20px_0_rgba(235,51,73,0.4)]">
            Send Reset Link
          </button>
        </div>
